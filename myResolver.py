...
def daddyPremium(codeIn=None):
    ...
    s = requests.Session()
    urlSrv="https://kondoplay.cfd/server_lookup.php?channel_id=premium"+codeIn
...
def daddyCode(codeIn=None):
    ...
    urlAuth="https://kondoplay.cfd/premiumtv/daddyhd.php?id="+codeIn
...
def PlayStream(link):
    ...
    urlAuth="https://kondoplay.cfd/premiumtv/daddylive.php?id="+link
    fu = s.get(urlAuth, headers=headers)
    logga ("AUTH_PAGE: "+fu.text)
    ...
    urlSrv="https://kondoplay.cfd/server_lookup.php?channel_id=premium"+link
    dataJson = s.get(urlSrv, headers=headers)
    arrJ = json.loads(dataJson.text)
    server=arrJ["server_key"]
